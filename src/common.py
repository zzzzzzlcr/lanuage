...
class CDPHelper:
    ...
    def click(self, selector: str, frame_id: str = "", timeout_ms: int = 3000) -> str:
        """
        ...
        timeout_s = max(timeout_ms / 1000.0, CDP_TIMEOUT)
        result = subprocess.run(
            cmd,
            shell=False,
            capture_output=True,
...
# click_checked removed — RadioStrategy uses eval-based activation.
# CDP click result checking now in newTaskTest SubprocessCDPClient.
